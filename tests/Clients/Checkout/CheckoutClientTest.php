...
namespace Axytos\ECommerce\Tests\Clients\Checkout;
...
class CheckoutClientTest extends TestCase
{
    ...
    /** @var CheckoutApiInterface|MockObject $checkoutApi */
    private CheckoutApiInterface $checkoutApi;
    
    /** @var PaymentMethodConfigurationInterface|MockObject $paymentMethodConfiguration */
